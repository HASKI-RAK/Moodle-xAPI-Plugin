...
/**
 * Transformer for booking form viewed event.
 *
...
function booking_form_viewed(array $config, \stdClass $event): array {
    ...
    return [[
        ...
        'object' => utils\get_activity\booking_form($config, $lang, $cmid),
        'context' => [
