...
/**
 * Transform for the discussion subscription deleted event.
 *
...
/**
 * Transformer for discussion subscription deleted event.
 *
...
function discussion_subscription_deleted(array $config, \stdClass $event): array {
    ...
    if (!$other) {
        ...
        $discussionid = (int)$other->discussion;
    ...
    return [[
        ...
        'object' => utils\get_activity\forum_discussion_subscription($config, $lang, $forumid, $discussionid, $cmid),
        'context' => [
