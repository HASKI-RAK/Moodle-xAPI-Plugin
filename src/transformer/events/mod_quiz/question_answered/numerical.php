 ...
 * @return array
 */
function numerical(array $config, \stdClass $event, \stdClass $questionattempt, \stdClass $question): array {
    ...
    return [[
        ...
        'result' => [
            ...
            'extensions' => [
                'http://learninglocker.net/xapi/cmi/numeric/response' => floatval($responsesummary),
            ],
        ],
        'context' => [
