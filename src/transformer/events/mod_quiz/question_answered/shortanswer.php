...
/**
 * Transformer for quiz question (shortanswer) answered event.
 *
 ...
 * @return array
 */
function shortanswer(array $config, \stdClass $event, \stdClass $questionattempt, \stdClass $question): array {
