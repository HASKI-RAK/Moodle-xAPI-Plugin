...
/**
 * Transform for submission form viewed event.
 *
...
/**
 * Transformer for submission form viewed event.
 *
...
function submission_form_viewed(array $config, \stdClass $event): array {
