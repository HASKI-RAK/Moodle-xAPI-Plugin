...
/**
 * Transform for remove submission form viewed event.
 *
...
/**
 * Transformer for remove submission form viewed event.
 *
...
function remove_submission_form_viewed(array $config, \stdClass $event): array {
    ...
    return [[
        ...
        'object' => utils\get_activity\course_assignment($config, $lang, $cmid, null, null, $assignid),
        'context' => [
