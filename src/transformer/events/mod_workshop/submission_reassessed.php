...
/**
 * Transformer for submission reassessed event.
 *
...
function submission_reassessed(array $config, \stdClass $event): array {
        ...
        'context' => [
            ...
            'contextActivities' => [
                'parent' => [
                    ...
                    utils\get_activity\workshop_assessable($config, $lang, $event->objectid, $cmid)
                ],
                'grouping' => [
