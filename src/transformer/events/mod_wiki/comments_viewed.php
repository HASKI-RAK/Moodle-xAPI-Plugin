...
/**
 * Transformer for comments viewed event.
 *
...
function comments_viewed(array $config, \stdClass $event): array {
    ...
    return [[
        ...
        'object' => utils\get_activity\comments($config, $lang, $wikiid, $cmid),
        'context' => [
