...
/**
 * Transformer for page diff viewed event.
 *
...
function page_diff_viewed(array $config, \stdClass $event): array {
    ...
    return [[
        ...
        'object' => utils\get_activity\wiki_page_diff($config, $pageid, $event->other, $lang, $cmid),
        'context' => [
