...
/**
 * Transformer for page history viewed event.
 *
...
function page_history_viewed(array $config, \stdClass $event): array {
    ...
    return [[
        ...
        'object' => utils\get_activity\wiki_page_history($config, $pageid,  $lang, $cmid),
        'context' => [
