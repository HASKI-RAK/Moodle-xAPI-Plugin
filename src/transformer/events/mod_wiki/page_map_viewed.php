...
/**
 * Transformer for page map viewed event.
 *
...
function page_map_viewed(array $config, \stdClass $event): array {
    ...
    return [[
        ...
        'object' => utils\get_activity\wiki_page_map($config, $pageid,  $lang, $cmid),
        'context' => [
