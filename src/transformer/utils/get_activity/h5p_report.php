 ...
 * @return array
 */
function h5p_report(array $config, string $lang, int $activityid, \stdClass $user, int $cmid, int $attemptid = null): array {
    ...
    if($attemptid !== null){
        ...
        $url = $config['app_url'].'/mod/h5pactivity/report.php?a=' . $activityid . '&userid=' . $userid;
    }
